html_sites <- list(
  ...
  CBS = list(
    ...
    stat_cols = c(
      ...
      dst_fum_rec = "DFR", dst_fum_force = "FF", dst_sack = "SACK", dst_td = "DTD",
  ...
  ESPN = list(
    ...
    stat_cols = c(
      ...
      dst_tackle = "DEFENSIVE TT", dst_sack = "DEFENSIVE SCK", dst_fum_force = "DEFENSIVE FF",
  ...
  FantasyData = list(
    ...
    stat_cols = c(
      ...
      dst_tfl = "TacklesForLoss", dst_sack = "Sacks", dst_qb_hits = "QuarterbackHits",
  ...
  FantasyPros = list(
    ...
    stat_cols = c(
      ...
      xp = "XPT", fumbles_lost = "MISC FL", dst_sack = "SACK", dst_int = "INT",
  ...
  FFToday = list(
    ...
    stat_cols = c(
      ...
      xp = "XP Made", xp_miss = "XP Miss", dst_sack = "Sack", dst_fum_rec = "FR",
  ...
  FleaFlicker = list(
    ...
    stat_cols = c(
      ...
      xp_att = "Kicking Att1", dst_int = "Defense INT", dst_sack = "Defense Sack",
  ...
  NumberFire = list(
    ...
    stat_cols = c(
      ...
      dst_yds_allowed = "Defense Yards Allowed" , dst_sack = "Defense Sacks",
  ...
  Yahoo = list(
    ...
    stat_cols = c(
      ...
      dst_pts_allowed = "Pts vs.",  dst_sack = "Tackles Sack", dst_safety = "Tackles Safe",
...
json_sites <- list(
  ...
  FantasyFootballNerd = list(
    ...
    stat_cols = c(pass_att = "passAtt", pass_comp = "passCmp", pass_yds = "passYds",
                  ...
                  dst_sack = "defSack" , dst_td = "defTD", dst_ret_tds = "defRetTD",
                  ...
                  rec_yds = "recYards", dst_sack = "sacks", dst_int = "interceptions",
  ...
  NFL = list(
    ...
    stat_cols = c(
      ...
      fg_4049 = "FG 40-49", fg_50 = "FG Miss 50+", dst_sack = "Sack", dst_int = "Int",
      dst_fum_Rec = "Fum Rec", dst_td = "TD", dst_pts_allowed = "Pts Allow",
